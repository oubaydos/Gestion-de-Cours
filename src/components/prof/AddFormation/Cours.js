...
export default function SignUp() {
  ...
  const submitFunc = async (data) => {
    if (!errors.title && !errors.numberOfCourses && !errors.description) {
      console.log("hh");
    } else {
      return;
    }
    ...
    try {
      console.log("dkhlna");
      await axios
        .post(`http://localhost:5000/addFormation`, data, {
          headers: {
          ...
          {sent && (
            <Box mt={5}>
              ...
              >
                ...
                <a style={{ textDecoration: "none" }} href="/prof/myformations">
                  Mes Formation
                </a>{" "}
                et choisir la nouvelle formation pour remplir les details dew
                cette formation
              </div>
            </Box>
          )}
                ...
                <TextField
                  ...
                  helperText={
                    errors.numberOfCourses
                      ? "le nombre de cours est obligatoire et doit contenir seulement des chiffres"
                      : ""
                  }
                />
              </Grid>
