  ...
  return (
    <div>
      {loading ? (
        ...
        <Course
          link="id"
          img={"http://localhost:5000/addCourse/" + courses.data[3].image}
          alt="course1"
          title={courses.data[3].title}
          author={courses.data[3].prof}
          rating={courses.data[3].rating}
          id={courses.data[3]._id} //khask tjibo mn back end :)
        />
      )}
    </div>
  );
