...
import image404 from "./photos/image404.svg";
import rocket from "./photos/rocket.svg";
import earth from "./photos/earth.svg";
import moon from "./photos/moon.svg";
import astronaut from "./photos/astronaut.svg";
import overlay_stars from "./photos/overlay_stars.svg";
        ...
        <Box className={styles.stars}>
          <Box className={styles.centralBody}>
            ...
            <Link to="/" className={styles.btnGoHome}>
              <Typography>RETOURNER</Typography>
            </Link>
          </Box>
