  ...
  return (
    <div>
      {loading ? (
        ...
        <Course
          link="id"
          img={"http://localhost:5000/addCourse/" + courses.data[2].image}
          alt="course1"
          title={courses.data[2].title}
          author={courses.data[2].prof}
          rating={courses.data[2].rating}
          id={courses.data[2]._id} //khask tjibo mn back end :)
        />
      )}
    </div>
  );
